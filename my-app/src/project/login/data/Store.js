...
const initialState = {
    ...
    typeCarArr: [
        ...
        { typeCode: '3', description: 'מנהלים' },
        { typeCode: '4', description: 'גיפ' },
        { typeCode: '5', description: 'מנהלים' },
        { typeCode: '6', description: 'מנהלים' },
        { typeCode: '7', description: 'מנהלים' },
        { typeCode: '8', description: 'משפחתי' },
        { typeCode: '9', description: 'משפחתי' },
        { typeCode: '10', description: 'מנהלים' },
        { typeCode: '11', description: 'מנהלים' },
        { typeCode: '12', description: 'משפחתי' }
    ...
    modelCarArr: [
        ...
        { modelCode: '6', company: 'מרצדס', model: 'AMG CLS Coupe', carCode: '6' },
        { modelCode: '7', company: 'לקסוס', model: 'GS', carCode: '7' },
        { modelCode: '8', company: 'אאודי', model: 'e-tron GT', carCode: '8' },
        { modelCode: '9', company: 'לקסוס', model: 'RS', carCode: '9' },
        { modelCode: '10', company: 'אאודי', model: 'A5', carCode: '10' },
        { modelCode: '11', company: 'לקסוס', model: 'IS', carCode: '11' },
        { modelCode: '12', company: 'איקספנג', model: 'G6', carCode: '12' },
        { modelCode: '13', company: 'לקסוס', model: 'RX', carCode: '13' },
        { modelCode: '14', company: 'מרצדס', model: 'Benz Classe C Coupe', carCode: '14' },
        { modelCode: '15', company: 'איקספנג', model: 'Mona M03', carCode: '15' },
        { modelCode: '16', company: 'מרצדס', model: 'Benz EQE', carCode: '16' },
        { modelCode: '17', company: 'אאודי', model: 'Q3', carCode: '17' },
        { modelCode: '18', company: 'קאדילק', model: 'CT5 Premium Luxury', carCode: '18' },
        { modelCode: '19', company: 'BMW', model: 'i8', carCode: '19' },
        { modelCode: '20', company: 'קאדילק', model: 'Escalade Sport Platinum', carCode: '20' },
        { modelCode: '21', company: 'אאודי', model: 'Q7', carCode: '21' },
        { modelCode: '22', company: 'זיקר', model: '007', carCode: '22' },
        { modelCode: '23', company: 'מרצדס', model: 'AMG SL', carCode: '23' },
        { modelCode: '24', company: 'יונדאי', model: 'Ioniq 5', carCode: '24' },
        { modelCode: '25', company: 'מרצדס', model: 'Benz CLA', carCode: '25' },
        { modelCode: '26', company: 'למבורגיני', model: 'Aventador', carCode: '26' },
        { modelCode: '27', company: 'פורד', model: 'Q3', Mustang: '27' },
        { modelCode: '28', company: 'אאודי', model: 'RS 5 2.9T Quattro', carCode: '28' },
        { modelCode: '29', company: 'מרצדס', model: 'Benz C-Class Cabriolet', carCode: '29' },
        { modelCode: '30', company: 'למבורגיני', model: 'Benz C-Class Cabriolet', carCode: '30' },
    ],
    countDrive: '7',
    driveTypeArr: [
        ...
        { driveTypeCar: '5', description: 'היברידי', price: '290000' },
        { driveTypeCar: '6', description: 'חשמלי', price: '370000' },
        { driveTypeCar: '7', description: 'חשמלי', price: '111000' },
        { driveTypeCar: '8', description: 'היברידי', price: '320000' },
        { driveTypeCar: '9', description: 'היברידי', price: '300000' },
        { driveTypeCar: '10', description: 'היברידי', price: '320000' },
        { driveTypeCar: '11', description: 'סולר', price: '310000' },
        { driveTypeCar: '12', description: 'סולר', price: '450000' }
    ...
    return: [
        ...
        { ReturnCode: "", QuestionCode: 2, returnDate: "2024-08-04", returnTime: "22:15", BalanceInLiters: "7", payment: "4377", isPayment: "true" },
